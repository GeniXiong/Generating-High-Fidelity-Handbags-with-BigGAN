...
parser.add_argument('--dataroot', default='dcgan', help='path to dataset')
...
parser.add_argument('--outf', default='dcgan_results', help='folder to output images and model checkpoints')
...
if opt.dataset in ['imagenet', 'folder', 'lfw']:
    # folder dataset
    dataset = dset.ImageFolder(root='data/bags_64',#opt.dataroot,
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 100 == 0:
            ...
            vutils.save_image(fake.detach(),
                    '%s/fake0_samples_epoch_%03d.png' % (opt.outf, epoch),
                    normalize=True)
